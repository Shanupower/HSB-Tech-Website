      ...
      <div className="industriesPageContainer">
        ...
        <div className="section whyChooseHSB" style={{ paddingInline: " 14%" }}>
          ...
          <p className="sectionSubHeading" style={{ fontSize: "22px" }}>
            ...
            mobile apps that offer seamless customer experienc
          </p>
          ...
          <div style={{ marginTop: "3.2rem" }}>
            ...
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                <ul>
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    <FiberManualRecordIcon sx={{ fontSize: "12px" }} /> Number
                    of pages
                  </li>
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    <FiberManualRecordIcon sx={{ fontSize: "12px" }} /> Order
            ...
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                integrate into your app are also two major determining factors
                of your project cost. To get an exact cost estimate, please
            ...
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                applications. We work on React Native, Swift, Android Native,
                and Flutter to build scalable mobile apps.
              </AccordionDetails>
            </Accordion>
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              <AccordionSummary
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                features, navigation and functionalities like Paytm. Our apps
                are integrated with dynamic and powerful features which are
                capable of competing with the top apps in the market.
              </AccordionDetails>
            </Accordion>
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              <AccordionSummary
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                Yes, we do have various in-house products that are secured and
                can be easily implemented in your existing technical
                infrastructure. Please connect us for details.
              </AccordionDetails>
            </Accordion>
          </div>
        </div>
