          ...
          <div style={{ marginTop: "3.2rem" }}>
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                Retail Management System assists retailers in managing
                end-to-end retail operations from procurement to sales and from
                order management to accounting, and so on. It helps retailers
                gain real-time visibility into retail activities and streamline
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                <ul>
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    ...
                    Inventory management: To track inventory levels, automate
                    stock replenishment, and avoid stockouts.
                  </li>
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                  ...
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    <FiberManualRecordIcon sx={{ fontSize: "12px" }} />{" "}
                    Reporting and Analytics: Generate comprehensive reports and
                    gain insights into key performance indicators (KPIs)
                  </li>

                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    <FiberManualRecordIcon sx={{ fontSize: "12px" }} /> Quality
                    Control: Implement quality control measures, and track
                    defect rates.
                  </li>

                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    <FiberManualRecordIcon sx={{ fontSize: "12px" }} />{" "}
                    Real-time Alerts: Get alerts and updates on the status of
                    your order, production, and transactions.
                  </li>
            ...
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                your development team. To get a more accurate estimate of the
                time it may take to build your specific app, consult us today.
              </AccordionDetails>
            </Accordion>
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              <AccordionSummary
