...
class RealEstateIndustry extends Component {
  state = {
    value: 0,
  };
      ...
      <div className="industriesPageContainer">
        ...
        >
          <div style={{ width: "60%" }}>
            ...
            >
              Bespoke real estate IT solutions that uplifts the entire real
              estate ecosystem. Integrating excellence with innovation to build
        ...
        <div className="solutions section" style={{ paddingInline: " 14%" }}>
          ...
          <p className="sectionSubHeading" style={{ fontSize: "22px" }}>
            We provide customer-centric real estate software development
            services leveraging the latest tools, techniques, and transformative
          ...
          >
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "22px" }}
              >
                Custom CRM in efficiently augmenting sales by tracking client
                data and managing customer interactions. We develop CRM software
                that best compliments your business operations by implying
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "22px" }}
              >
                Our team of dedicated ERP developers are well-versed with
                building software that can easily manage commercial and
                residential property data, inventory administration, financial
                transactions recording, and other processes.
              </p>
            </div>
            <div
              className="card-service"
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "22px" }}
              >
                Our strength lies in developing property management software
                using interactive interfaces and task automation tools to align
        ...
        <div className="section whyChooseHSB" style={{ paddingInline: " 14%" }}>
          ...
          <p className="sectionSubHeading" style={{ fontSize: "22px" }}>
            ...
            comprehensive solutions to develop and maintain high-end
            applications.
          </p>
          <div
            className="cardsContainer-services"
          ...
          >
            ...
            >
              ...
              >
                ...
                where technologies related to AR/VR are used to create a
                realistic experience to the prospective buyers. We create web
                and mobile applications with realistic visuals and a complete
                augmented reality to enhance realtime experience of possessing
                the property.
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                rental, or lease. It can be used for agricultural, commercial,
                or residential properties or for multiple types of properties.
              </p>
            </div>
            <div
              className="card-service"
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "22px" }}
              >
                We develop applications for your various real estate
                requirements such as sale, rental, auction, etc. The real estate
                modules track the live status of property dealings and keep you
                updated with the real-time transactions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="section" style={{ paddingInline: " 14%" }}>
          ...
          <p className="sectionSubHeading" style={{ fontSize: "22px" }}>
            ...
            can be customized for your real estate business requirement –
          </p>
