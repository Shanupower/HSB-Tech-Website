          ...
          <div style={{ marginTop: "3.2rem" }}>
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                Yes, we do. We collaborate with businesses of all sizes,
                including start-ups and large-scale organizations.
              </AccordionDetails>
            </Accordion>
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              <AccordionSummary
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                assessed based on various factors such as size and features of
                the app. We suggest you to get in touch with us to get an
                approximate estimate of the development cost.
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                Here are a few ways in which custom eLearning solutions can
                work:
                <ul>
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    <FiberManualRecordIcon sx={{ fontSize: "12px" }} /> Ensuring
                    Provides personalized and tailored learning experience to
                    each individual learner.
                  </li>
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
                    <FiberManualRecordIcon sx={{ fontSize: "12px" }} /> Ensuring
                    Offering content that is specifically targeted to the needs
                    of the organization.
                  </li>
                  <li style={{ paddingBlock: ".2rem", fontSize: "20px" }}>
            ...
            <Accordion sx={{ borderRadius: "14px", marginBlock: ".8rem" }}>
              ...
              <AccordionDetails sx={{ fontSize: "20px" }}>
                ...
                can be used for training as well as for your overall operations
